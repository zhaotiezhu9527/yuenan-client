...
public class InfomationController {
    ...
    public R register(@Validated InfomationRequest request) {
        ...
        information.setUserName(request.getUserName());
        information.setUserPhone(request.getUserPhone());
        information.setUserAge(request.getUserAge());
        information.setUserSalary(request.getUserSalary());
        information.setUserJob(request.getUserJob());
        information.setUserCar(request.getUserCar());
        information.setUserMarriage(request.getUserMarriage());
        information.setUserFb(request.getUserFb());
